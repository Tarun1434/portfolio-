...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const scriptURL = "https://script.google.com/macros/s/AKfycbx28mGsYK7vb_J5t-At3aF_MGzxHCXUkiGw3P3Rk5hjui0AsepnOYG09gpgjLR1NBDi/exec"; // <-- Replace this with your actual Google Apps Script Web App URL
          ...
          <div className="bg-gray-50 dark:bg-gray-700 p-8 rounded-lg shadow-md">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <a href="mailto:tarunpotnuru2251@gmail.com" className="text-emerald-600 dark:text-emerald-400 hover:underline">
              ...
              <div>
                ...
                <a href="tel:+918712126284" className="text-emerald-600 dark:text-emerald-400 hover:underline">
                  +91 8712126284
                </a>
              </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-emerald-500 resize-none"
